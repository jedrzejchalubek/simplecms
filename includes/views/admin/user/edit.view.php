...
<article class="content__wrapper">
		...
		<ul class="content__nav__wrapper">
			<li class="content__nav__item">
				<button class="content__nav__item-a button-update" type="submit" form="form--edit">
					<div class="button button-text"><i class="button-icon icon-refresh"></i> Update user</div>
				</button>
			</li>
		</ul>
	</nav>
	<div class="content__containers">
		...
		<div class="content__edit container-fluid">
			<div class="row-fluid">
				<div class="row12"><h1>Editing "<?php echo $user['username']; ?>"</h1></div>
			</div>
			<div class="row-fluid">
				<div class="span10">
					<form class="form-verical" id="form--edit" method="POST">
						<div class="control-group">
							...
							<div class="controls">
								<input value="<?php echo $user['username']; ?>" id="register-username" type="text" pattern="[a-zA-Z0-9]{5,64}" name="username" required />
							</div>
							<label class="control-label" for="register-email">Email:</label>
							<div class="controls">
								<input value="<?php echo $user['email']; ?>" id="register-email" type="email" name="email" required />     
							</div>
							...
							<div class="controls">
								<input value="<?php echo $user['first_name']; ?>" id="register-firstname" type="text" pattern="{1,64}" name="first_name" required />
							</div>
							<label class="control-label" for="register-lastname">Lastname:</label>
							<div class="controls">
								<input value="<?php echo $user['last_name']; ?>" id="register-lastname" type="text" pattern="{1,64}" name="last_name" required />
							</div>
						</div>
					</form>
				</div>
